...
public class orderPanelTest {
  ...
  @Test(alwaysRun = false, priority = 3)
  ...
  public void editOrderTest() throws InterruptedException {
	  ...
	  //http://savetext.net/KkUdJ53XnsvynDhvf9tt
		...
		Select dropSelectRole = new Select(driver.findElement(By.name("trangthai_form")));
		dropSelectRole.selectByVisibleText("Đã nhận");
		driver.findElement(By.name("Action2")).click();
		assertTrue(true);
  ...
  public void deleteOrderTest() throws InterruptedException {
	  Thread.sleep(1000);
	  driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/center/div/table/tbody/tr[2]/td[10]/center/a")).click();
  ...
  public void findProductTest() throws InterruptedException {
	  Thread.sleep(500);
	  driver.get("http://localhost:8080/ASM_Java5_BanHang/admin/donhang.html");
	  Thread.sleep(2000);
	  driver.findElement(By.cssSelector("#bootstrap-data-table-Login_filter > label > input[type=search]")).sendKeys("admin");
	  Thread.sleep(2000);
	  String actual = driver.findElement(By.xpath("/html/body/div[1]/div/div[2]/center/div/table/tbody/tr[1]/td[7]")).getText();
  ...
  public void editProductTest() throws InterruptedException {
	  ...
	  driver.findElement(By.name("tensp_form")).sendKeys("thanhbnedit");
